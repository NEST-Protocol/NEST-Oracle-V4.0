...
//                 return;
//             }
//             await nestBatchMining.connect(addr1).takeToken1(0, 0, 0, 1, toBigInt(0.5), {
...
//                 await nestBatchMining.takeToken1(0, 0, 1, 2, toBigInt(0.6), {
...
//                 expect(toDecimal(await nestBatchMining.balanceOf(nest.address, owner.address))).eq(toDecimal(toBigInt(100000 + 400000)));
//                 expect(toDecimal(await nestBatchMining.balanceOf(nhbtc.address, owner.address))).eq(toDecimal(toBigInt(10)));
    
//                 expect(toDecimal(await nestBatchMining.balanceOf(usdt.address, addr1.address), 6)).eq(toDecimal(toBigInt(2000 * 4, 6), 6));
//                 expect(toDecimal(await nestBatchMining.balanceOf(nest.address, addr1.address))).eq(toDecimal(toBigInt(200000)));
//                 expect(toDecimal(await nestBatchMining.balanceOf(nhbtc.address, addr1.address))).eq(toDecimal(toBigInt(0)));
...
//                 await nestBatchMining.withdraw(usdt.address, toBigInt(2000 + 2000 + 2000 * 4, 6));
//                 await nestBatchMining.withdraw(nest.address, toBigInt(100000 + 400000));
//                 await nestBatchMining.withdraw(nhbtc.address, toBigInt(10));
//                 await nestBatchMining.connect(addr1).withdraw(usdt.address, toBigInt(2000 * 4, 6));
//                 await nestBatchMining.connect(addr1).withdraw(nest.address, toBigInt(200000));
//                 await nestBatchMining.connect(addr1).withdraw(nhbtc.address, toBigInt(0));

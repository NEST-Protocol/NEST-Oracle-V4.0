...
describe('NestOpenMining', function() {
    it('First', async function() {
        ...
        if (true) {
            ...
            expect(toDecimal(await nestOpenMining.balanceOf(hbtc.address, owner.address))).eq(toDecimal(1000000000000000000n));
            expect(toDecimal(await nestOpenMining.balanceOf(usdt.address, owner.address), 6)).eq(toDecimal(60000000000n, 6));

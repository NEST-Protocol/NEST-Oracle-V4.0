...
describe('NestOpenMining', function() {
    it('First', async function() {
        ...
        if (true) {
            ...
            await nestBatchMining.connect(addr1).take(0, 0 - 0xFFFF, 0, 1, toBigInt(0.5), {
            ...
            if (false) {
                ...
                console.log('2. 吃单链');
                await nestBatchMining.take(0, 0 - 0xFFFF, 1, 2, toBigInt(0.6), {
            ...
            if (true) {
                ...
                await nestBatchMining.withdraw(nest.address, toBigInt(100000 + 400000 + 10));
            ...
            let count = await nestBatchMining.getAccountCount();
            console.log('getAccountCount: ' + count);
            for (var i = 0; i < count; ++i) {
                let addr = await nestBatchMining.indexAddress(i);
                let idex = await nestBatchMining.getAccountIndex(addr);

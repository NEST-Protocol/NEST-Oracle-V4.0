...
describe('NestOpenMining', function() {
    it('First', async function() {
        ...
        // await nest.approve(nestBatchMining.address, toBigInt(100000000));
        // await usdt.transfer(owner.address, toBigInt(1000000));
        // await usdt.approve(nestBatchMining.address, toBigInt(10000000));
        // await hbtc.transfer(owner.address, toBigInt(1000000));
        // await hbtc.approve(nestBatchMining.address, toBigInt(100000));

        await nestBatchMining.post(0, 1, [toBigInt(200000), toBigInt(0.07)]);
    });
});
